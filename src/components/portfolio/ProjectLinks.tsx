 ...
 * opening the URL in an in-app browser. Built here (with the icon pipeline) so
 * Phase 5's project detail screen can drop it straight in. Premium bar: haptic
 * tick + pressed state on every pill.
 *
